...
class general(commands.Cog, name="general"):
    ...
    async def botinfo(self, context: SlashContext):
        ...
        embed = discord.Embed(description="Used Krypton's template", color=0x42F56C)
        embed.set_author(name="Bot Information")
        embed.add_field(name="Owner:", value="Krypton#2188", inline=True)
        embed.add_field(
    ...
    @cog_ext.cog_slash(name="ping", description="Check if the bot is alive.")
    ...
    async def poll(self, context: SlashContext, title: str):
        ...
        embed = discord.Embed(
            title="A new poll has been created!", description=f"{title}", color=0x42F56C
        )
        embed.set_footer(text=f"Poll created by: {context.author} • React to vote!")
    ...
    @cog_ext.cog_slash(name="bitcoin", description="Get the current price of bitcoin.")
